...
export const createProductSchema = z
  .object({
    ...
    usage: z
      .object({
        type: z.enum(['owner', 'assigned', 'pending', 'rejected', 'outright', 'rented']).default('owner'),
...
export const listProductsSchema = z.object({
  ...
  usageType: z.enum(['owner', 'assigned', 'pending', 'rejected', 'outright', 'rented', '']).optional().default(''),
  ...
  sortBy: z.enum(['createdAt', 'jewelCode', 'qty', 'weight', 'price', 'livePrice']).optional().default('createdAt'),
