...
import { MetalLiveRate } from '../../product/controller/product.helper'
import { ProductModel } from '../../product/model/product.schema'
import type { MetalRates } from '../../product/utils/pricing'
...
export const assignProductController = CatchError(async (req: Request & { user?: any }, res: Response) => {
  ...
  const { productId, jewelerId, usageChoice, remark } = req.body
