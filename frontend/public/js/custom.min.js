...
!(function (t, e) {
  ...
  var v =
      'undefined' != typeof Element && (Element.prototype.matches || Element.prototype.webkitMatchesSelector || Element.prototype.mozMatchesSelector || Element.prototype.msMatchesSelector),
    m = {
      main: 'ps',
      element: {
        thumb: function (t) {
          ...
          if (!this.transitioning && o(e).hasClass(h)) {
            ...
            if ((t.trigger(i), !i.isDefaultPrevented())) {
              ...
              var r = function () {
                n.config &&
                  n.element &&
                  (n.transitioning && n.config.onTransitionEnd && n.config.onTransitionEnd(), n.setTransitioning(!1), t.trigger(u.HIDDEN), t.removeClass(c).addClass(d));
              };
